...
import bgMusic from './components/music/apocalypse.mp3';
    ...
    >
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="w-full text-center mb-4">
          <h3 className="text-2xl font-bold text-[#FF6F69]">💗The love of my life</h3>
...
function App() {
  ...
  const messages = [
    "Heyooo DUMB SHATAKSHII!! Happy Birthdayyy...😭🙏🏿🫶🏻",
    "Lets Celebrate!!!🥳",
  ];
