...
import songC from "./music/blue.mp3";
...
const photos: Photo[] = [
  {
    url: Pic1,
    caption: "So many places, but only one feels like Home—YOU DUMB AURAT SHATAXI!🎀...",
  },
  {
    url: Pic2,
    caption: "Yep we are stuck for life😭🙏🏿🎀...",
  },
  {
    url: Pic3,
    caption: "Your presence feels like home- My favourite place to be...",
  },
];
...
const extraPhotos: Photo[] = [
  ...
  { url: Pic5, caption: " MY PRETTIEST LOML 'shes the best thing that  ever  happened to me haha" },
];
...
const TimelineComponent: React.FC<{ onProceed: () => void }> = ({ onProceed }) => {
  const timelineEvents = [
    { icon: "🌟", title: "A First Encounter With Destiny!", desc: "on snapchat (14/11/22)" },
    { icon: "💗", title: "The First Time You Held My Hand VIRTUALLY", desc: "07:43PM (26/11/22)," },
    { icon: "🫂", title: "Our First Confession, Most Precious Day", desc: " 9:22PM (22/11/22)" },
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-gray-700 text-lg text-center px-2">🎀</p>
                        ...
                        <p className="text-gray-700 text-lg text-center px-2">I'M SOO IN LOVEE WITH YOUUU SOFIII!!...</p>
                        <p className="text-gray-700 text-lg text-center px-2">🎀</p>
